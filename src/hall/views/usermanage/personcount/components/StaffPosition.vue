<template>
  <div class="wrap">
    ...
    <div class="cell cell-middle">
      <p class="title">人员窗口职位占比</p>
      <a-spin :spinning="loading" v-if="loading"></a-spin>
      <div class="chart" ref="chart" v-else></div>
    </div>
    <div class="cell">
      <staff-gather></staff-gather>
    </div>
  </div>
</template>
<script>
...
import { staffposition } from "@/hall/api/personcount";
import { mixins } from "../minxin/index";
import { showError } from "@/framework/utils/index";
import {Spin} from 'ant-design-vue';
import StaffGather from "./gather/StaffGather";
export default {
  components: {ASpin:Spin, CustomIcon,StaffGather },
  data() {
    return {
      list: [],
      total: 0,
