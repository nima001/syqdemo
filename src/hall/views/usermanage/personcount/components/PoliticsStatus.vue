<template>
  <div class="wrap">
    ...
    <div class="cell">
      <politics-gather></politics-gather>
    </div>
  </div>
</template>
<script>
...
import { politics } from "@/hall/api/personcount";
import { mixins } from "../minxin/index";
import { showError } from "@/framework/utils/index";
import {Spin} from "ant-design-vue"
import PoliticsGather from "./gather/PoliticsGather";
export default {
  components: {ASpin:Spin, CustomIcon,PoliticsGather },
  data() {
    return {
      list: [],
      total: 0,
