<template>
  <div>
    <div class="sexWrap">
      ...
      <div class="cell">
        <p class="title">人员性别占比</p>
        <a-spin :spinning="loading" v-if="loading"></a-spin>
        <div class="chart" ref="chart" v-else></div>
      </div>
    </div>
    <div class="sex-gather">
      <sex-gather></sex-gather>
    </div>
  </div>
</template>
<script>
...
import { sex } from "@/hall/api/personcount";
import { mixins } from "../minxin/index";
import { showError } from "@/framework/utils/index";
import { Spin } from "ant-design-vue";
import SexGather from "./gather/SexGather";
export default {
  components: { ASpin: Spin, CustomIcon, SexGather },
  data() {
    return {
      list: [],
      total: 0,
