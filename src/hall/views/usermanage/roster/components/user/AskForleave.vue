  ...
  <div class="layout">
    <div class="content">
      <div class="top">
        <div class="left">
          <div class="cell">
            <span class="title">剩余年休假：</span>
            <span class="days">{{total.annual}}次</span>
          </div>
          <div class="cell">
            <span class="title">剩余调休假：</span>
            <span class="days">{{total.compensatory}}次</span>
          </div>
        </div>
        <div class="right">
          <a-month-picker
...
export default {
  ...
  methods: {
    ...
    getTotal(){
      holidays(this.$route.query.userid)
        .then(res=>{
