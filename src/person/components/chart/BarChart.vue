<template>
  <div ref="content" class="bar-chart" :style="{width: width?`${width}px`:'100%', height: height?`${height}px`:'400px'}">
...
import { get, orderBy, reduce, map, groupBy, xor, has, keys, assign } from 'lodash';
