<template>
  <a-form-item v-if="formLayout != 'horizontal'" :label="name" :required="!!required" :validateStatus="validateStatus"  >
    <a-tooltip placement="topLeft" :title="help">
      <a-date-picker :style="{width:'100%'}" v-model="propValue" :disabled="!!disabled" :class="{notEditor:!editor}" :title="propValue"></a-date-picker>
    </a-tooltip>
  </a-form-item>
  <a-form-item v-else  :required="!!required" :validateStatus="validateStatus" >
    <div class="compact">
      ...
      <a-tooltip placement="topLeft" :title="help">
        <a-date-picker v-model="propValue" :disabled="!!disabled" :class="{notEditor:!editor}" :title="propValue"></a-date-picker>
      </a-tooltip>
    </div>
  </a-form-item>  
</template>
