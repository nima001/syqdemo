    ...
    <div class="cell">
      <div class="cellItem">
        ...
        <div
          ...
          used: 'hdldzsqy_sy',
          unittypes: [1, 5, 7],
          field: { code: 'ldzsck', name: '空职'}
        })"
        >
          <lcd-font :length="4" :realNumber="(postInfo['hdldzsqy'] - postInfo['hdldzsqy_sy']) | thanZero"></lcd-font>
        </div>
        <div class="type">
      ...
      <div class="cellItem">
        ...
        <div
          ...
          used: 'hdzcldzsqy_sy',
          unittypes: [1, 5, 7],
          field: { code: 'xzzcldzscks', name: '空职'}
        })"
        >
          <lcd-font
            :length="4"
            :realNumber="(postInfo['hdzcldzsqy'] - postInfo['hdzcldzsqy_sy']) | thanZero" 
          ></lcd-font>
        </div>
        <div class="type">
          <span class="name">核定</span>
    ...
    <div class="cell last">
      <div class="cellItem">
        ...
        >
          <lcd-font
            :length="4"
            :realNumber="(postInfo['syhdldzsqy'] - postInfo['syhdldzsqy_sy']) | thanZero"
            :realStyle="realStyle"
          ></lcd-font>
        </div>
        <div class="type">
      ...
      <div class="cellItem">
        ...
        >
          <lcd-font
            :length="4"
            :realNumber="(postInfo['syhdzcldzsqy'] - postInfo['syhdzcldzsqy_sy']) | thanZero"
            :realStyle="realStyle"
          ></lcd-font>
        </div>
        <div class="type">
...
export default {
  ...
  */
  methods: {
    ...
    showDetail({ title, total, used, unittypes, field }) {
