      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { name: '机构编制使用效益', a: 'jgbzsyxy', b: 'jgbzsyxybgz', weight: 3, unit: '%'},
          ]
        }
      ]
    },
    ...
    { 
      ...
      children: [
        ...
        },
        {
          name: '组织成长',
          children: [
            { name: '人员培养经费占比', a: 'rybyjfzb', b: 'rybyjfzbbgz', weight: 4, unit: '%'},
            { name: '机构编制使用效益', a: 'jgbzysxy', b: 'jgbzysxybgz', weight: 4, unit: '%'},
          ]
        }
      ]
    },
    { 
      ...
      children: [
        ...
        },
        {
          name: '管理水平',
          children: [
            { name: '师德违规问题处罚数量', a: 'sdwgwtcfsl', b: 'sdhglbgz', weight: 4, unit: '次', calculate: (data) => {
              let { sdwgwtcfsl = 0, sdhglbgz = 0 } = data || {};
              return Math.max(sdhglbgz, 4 - sdwgwtcfsl);
            }},
