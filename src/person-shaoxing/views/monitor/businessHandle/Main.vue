...
import { getPreMonth, getNowFormatDate } from "@/person-shaoxing/utils/index";
import 'moment/locale/zh-cn'
moment.locale('zh-cn')

let curMonth = moment(getPreMonth(getNowFormatDate()), 'YYYY-MM'),
    startMonth = moment(getPreMonth(getNowFormatDate()).split('-')[0] + '-01','YYYY-MM'),
