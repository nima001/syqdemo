    ...
    <a-modal 
      ...
      @cancel="handleCancel">
        <a-form :form="form" :label-col="{ span: 4 }" :wrapper-col="{ span: 19 }">
          ...
          <a-form-item  v-if="form.getFieldValue('type') ? [1, 3].includes(form.getFieldValue('type').key) : true"
            label="文件归属单位"
            v-decorator="['']"
            :wrapper-col="{ span: 10 }"
...
<script>
import { Form, Input, DatePicker, Button, Select, Icon, Modal, Divider, TreeSelect } from "ant-design-vue";
