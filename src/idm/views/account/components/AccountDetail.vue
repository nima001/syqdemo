 <template>
  <div class="account-detail" ref="accountDetail">
      ...
      >
        ...
        <template slot="operation" slot-scope="text, record">
          <div class="editable-row-operations">
            ...
            <span>
              <a @click="openDelete(record)">注销</a>
            </span>
            <span>
    ...
    >
      <reset-pwd :account="this.resetAccount" @finish="resetOk" @cancel="resetCancel"/>
    </a-modal>
    <a-modal
      :footer="null"
    ...
    >
      <account-delete :account="this.deleteAccount" @finish="deleteOk" @cancel="deleteCancel" />
    </a-modal>
  </div>
</template>
<script>
    ...
    customRow(row){
      return {
        on: {
          ...
          dblclick: (event) => {
            this.$router.push({name: 'accountInfo', query: { accountId: row._id }});
          },
        }
      };
    },
    edit(key){
      this.$router.push({name: 'accountInfo', query: { accountId: key._id }});
    },
    resetPwd(key){
      this.resetAccount = key;
