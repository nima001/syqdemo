<template>
  ...
  >
    ...
    <dialog-box 
      v-model="NotRetire.show"
      :title="NotRetire.title"
      :destroyOnClose="true"
    >
      <component :is="target"/>
    </dialog-box>
...
import NotRetire from '../components/NotRetire';
import RetireDetail from '../components/RetireDetail';
  ...
  methods: {
    ...
    onClick(item){
      if(this.$listeners.click){
        ...
        this.NotRetire = { show: true, orgid: item._id, title: item.name }
      }
    }
  }
}
