  ...
  <div class="layout">
    ...
    <div class="content-right">
      <div class="top">
        ...
        <div class="top-right">
          <a-range-picker :disabledDate="disabledDate" :style="{width:'200px',margin:'0px 10px'}" @change="dateChange" v-model="query.date" allowClear></a-range-picker>
...
export default {
  ...
  data() {
    return {
      ...
      query: {
        searchkey: undefined,
        date: [moment(new Date().toLocaleDateString()).startOf('month'),moment(new Date().toLocaleDateString())]
      },
      pagination: {
        pagesize: 10,
        pagenum: 1,
  ...
  methods: {
    disabledDate(current) {
      return current && current >= moment(moment().add(0, 'days')).endOf('day');
    },
    onExport() {
