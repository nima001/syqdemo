  ...
  <div class="layout">
    ...
    <div class="content-right">
      <div class="top">
        ...
        <div class="top-right">
          <a-range-picker :disabledDate="disabledDate" :style="{width:'200px',margin:'0px 10px'}" v-model="query.date" @change="dateChange"></a-range-picker>
...
export default {
  ...
  data() {
    return {
      ...
      query: {
        searchkey: undefined,
        date: [moment(new Date().toLocaleDateString()),moment(new Date().toLocaleDateString()).endOf('month')]
      },
      pagination: {
        pagesize: 10,
        pagenum: 1,
  ...
  methods: {
    disabledDate(current) {
      return current && current <= moment(moment().add(-1, 'days')).endOf('day');
    },
    getData() {
      this.loading = true;
