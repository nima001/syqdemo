        ...
        <a-layout-content>
          <a-list item-layout="vertical" :loading="spinning" :data-source="data">
            <a-list-item slot="renderItem" slot-scope="item, index">
              <a-list-item-meta>
                <span slot="title" style="fontWeight: bold;" v-html="item.redname||'undefinded'"/>
                <p slot="title" v-html="item.reddesc"/>
              </a-list-item-meta>
              <p slot="actions">
    ...
    orgtermSearch(){
      ...
      orgtermsearch(this.pagination).then((res)=>{
        ...
        res.result.rows.forEach((item,index)=>{
          res.result.rows[index].redname=item.name?this.brightenKeyword(this.transformationContent(item.name)):undefined;
          res.result.rows[index].reddesc=item.desc?this.brightenKeyword(this.transformationContent(item.desc)):undefined;
        });
