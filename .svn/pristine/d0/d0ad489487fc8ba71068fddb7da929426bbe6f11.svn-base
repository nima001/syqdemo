...
export default {
  ...
  computed: {
    ...
    params(){
      ...
      if(this.jgtypes){
        criteria.push({
          field: { key: "complietype", showname: "编制类型" },
          op: 'in',
          value: this.jgtypes,
        })
      }
