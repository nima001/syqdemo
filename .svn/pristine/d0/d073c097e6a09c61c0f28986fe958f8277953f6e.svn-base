      ...
      <a-row :style="{marginBottom:'8px'}">
        ...
        <a-col :span="20">
          <div class="queryButton">
            <dict-select v-model="searchdata.namespace" 
              dict="report.booknamespace"
              allowClear
              class="queryitem" 
              style="width: 160px" 
              placeholder="报表分类"
            ...
            <a-select v-model="searchdata.onepage" class="queryitem" allowClear style="width: 160px" placeholder="报表类型">
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          title: "报表分类",
          dataIndex: "namespace",
          customRender: this.dictRender('report.booknamespace')
        },
        {
          title: "相关单位",
          dataIndex: `orgname`
