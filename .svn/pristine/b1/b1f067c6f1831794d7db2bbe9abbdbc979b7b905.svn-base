<template>
  <div class="wrap">
    <div class="top">
      <span class="title">按区域查看权力变化数</span>
      <ul class="tipList">
        <li>
