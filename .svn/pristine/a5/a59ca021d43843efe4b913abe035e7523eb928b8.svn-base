      ...
      >
        ...
        <div class="time-list">
          <div class="list-onediv">
            <span style="font-weight: 700">时间： {{ item.documentVo.dispatchdate }}</span>
            <span style="font-weight: 700">文号： {{ item.documentVo.num }}</span>
          </div>
...
export default {
  ...
  created() {
    //职责
    this.typearr = this.$store.getters.dict("person.orgfuncdesctype");
