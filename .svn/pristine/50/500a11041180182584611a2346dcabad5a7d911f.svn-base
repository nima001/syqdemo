  ...
  data(){
    return {
      ...
      columns: [
        ...
        { title: '分类', dataIndex: 'category', width: '8%', customRender: this.dictRender("person.work.taskcategory")},
        { title: '发布人', dataIndex: 'createusername', width: '8%',},
        { title: '主办处室', dataIndex: 'mainorg', width: '15%',},
        { title: '主办人', dataIndex: 'mainusername', width: '8%',},
        ...
        { title: '截止时间', dataIndex: 'deadtime', width: '8%',
        ...
        // }},
        { title: '状态', dataIndex: 'status', width: '8%', customRender: (text) => {
