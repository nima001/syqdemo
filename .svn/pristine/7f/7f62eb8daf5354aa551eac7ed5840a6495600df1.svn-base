        ...
        <div class="bottom-chart">
          <div class="chart3 chart">
            <chartconsole
              ...
              :setting="{ 'rangeControl': true, padding: [50, 0, 0, 0], xAxis:{ disabled: true, title: { disabled: true, content: '时间'} }, yAxis:{ disabled: true, grid: true, title: { disabled: true, content: '事项数'} } }"
...
export default {
  ...
  data() {
    return {
      ...
      settingOne: { 
        xAxis: { disabled: true, title: { disabled: true, content: '区域'} }, 
        yAxis: { disabled: true, grid: true, title: { disabled: true, content: '事项数'} },
        padding: [50, 0, 0, 0], 
        gemo: { background: true, color: ['#BDF33F','#76C722'], annotation: true, size: 28, label: true }, 
        legend: {visible: true, position: 'top'},
      },
      settingTwo: { 
        xAxis: { disabled: true, title: { disabled: true, content: '共性事项数'} }, 
        yAxis:{ disabled: true, grid: true, title: { disabled: true, content: '事项数'} },
        gemo: { background: true, color: ['#6279FD'], annotation: true, size: 28, label: false },
