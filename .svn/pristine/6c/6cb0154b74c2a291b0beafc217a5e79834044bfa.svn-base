<template>
  <div>
    ...
    <div class="exam-gather">
      <exam-gather></exam-gather>
    </div>
  </div>
</template>
<script>
...
import { exam } from "@/hall/api/personcount";
import { mixins } from "../minxin/index";
import { showError } from "@/framework/utils/index";
import { Spin } from "ant-design-vue";
import ExamGather from "./gather/ExamGather";
export default {
  components: { ASpin: Spin, CustomIcon, ExamGather },
  data() {
    return {
      list: [],
      total: 0,
