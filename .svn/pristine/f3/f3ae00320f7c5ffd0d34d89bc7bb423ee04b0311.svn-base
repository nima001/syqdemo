    ...
    <div class="panel">
      <div class="toolbar">
        ...
        <div class="right">
          <!-- <dict-select
            ...
            placeholder="策略类型"
          ></dict-select> -->
          <a-select class="search-item" :default-value="-1" @change="changeStatus">
      ...
      <div class="tablecontent">
        ...
        <span slot="action" class="operation" slot-scope="text, record">
          ...
          <a href="javascript:;" :disabled="record.runstatus !== 1 || record.strategytype === 4" @click="executeStrategy(record.id)">执行</a>
...
export default {
  ...
  methods: {
    ...
    strategytypeChange(val){
      if(val){
        this.searchCondition.strategytypeIn = [val];
      }else{
        this.searchCondition.strategytypeIn = null;
      }
    },
    addStrategy(){
