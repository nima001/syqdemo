          ...
          filter: {
            ...
            criteria: [
              { field: { key: "district" }, op: "eq", value: this.dictId },
              {
                op: 'or',
                criteria: [
                  { field: { key: "unittype", showname: "单位类别" }, op: "in", value: [2, 3] },//参公、事业单位
                  {
                    op: 'and',//行政单位排除设在党政部门的机关、人大、政协
                    criteria: [
                      { field: { key: "unittype", showname: "单位类别" }, op: "eq", value: 1 },
                      { field: { key: "syssort" }, op: "nin", value: ["a14", "a20", "a40"] },
                    ]
                  },
                  {
                    op: 'and',//行政（人大、政协）的办公室
                    criteria: [
                      { field: { key: "unittype", showname: "单位类别" }, op: "eq", value: 1 },
