    ...
    <div class="right">
      <ul>
        <li>
          ...
          <span class="num" @click="()=> questionList = {show:true,title:'暂缓问题详情', lcdTitle:'暂缓问题数', params:{needtotal:true,defer: 1,handlestatus: 0,district:dictId}}">{{questionNum.temp || 0}}</span>
        </li>
        <li>
