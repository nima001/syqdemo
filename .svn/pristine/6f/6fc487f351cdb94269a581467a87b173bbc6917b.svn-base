    ...
    <div v-if="show">
      ...
      <!-- <a-row :gutter="10">
        <a-col :span="4" :offset="7">
          <input-text :property="property.childs[13]" :bindform="bindform"></input-text>
        </a-col>
        ...
        <a-col :span="1" class="lineHeight">）</a-col>
        <a-col :span="4">
          <number-box :property="property.childs[15]" :bindform="bindform"></number-box>
        </a-col>
        <a-col :span="1" class="lineHeight">号</a-col>
      </a-row> -->
    </div>
    <div class="showUnitLetter" v-else>
      <h2>{{property.name}}</h2>
      <div class="head">
