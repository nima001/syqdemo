    ...
    <div class="content-right">
      <div class="top">
        ...
        <div class="top-right">
          ...
          <a-input-search placeholder="请输入窗口名称" :style="{width:'200px',marginLeft:'10px'}" enter-button @search="inputSearch" allowClear v-model="query.searchkey"></a-input-search>
        </div>
      </div>
      <div class="middle">
...
import { windowinspectlist,favorablefeedbackdelete } from "@/hall/api/hallmanage";
