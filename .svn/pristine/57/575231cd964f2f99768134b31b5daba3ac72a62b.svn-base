  ...
  data(){
    return {
      ...
      columns: [
        ...
        { title: '分类', dataIndex: 'category', width: '14%', customRender: this.dictRender("person.work.taskcategory")},
        { title: '发布人', dataIndex: 'createusername', width: '14%', },
        // { title: '协办处室', dataIndex: 'asistorgnames', customRender: this.asistorgRender()},
        // { title: '协办人', dataIndex: 'asistusernames'},
        { title: '截止时间', dataIndex: 'deadtime', width: '14%', 
        ...
        //   }
        // },
        { title: '状态', dataIndex: 'status', width: '14%', customRender: (text) => {
