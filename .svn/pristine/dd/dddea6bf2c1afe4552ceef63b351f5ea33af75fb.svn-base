  ...
  <div class="content">
    ...
    <div class="table">
      <div class="tableBody">
          ...
          >
            <tr v-for="(item,index) in analyzeData" :key="item.id">
              ...
              <td class="action">
                ...
                <span @click="push(impowerpath, item.id)">
        ...
        <div class="empty" v-if="!this.analyzeData.length">
    ...
    text(){
      if(this.analyzeData){
        this.analyzeData.forEach((item) => {
          let datatypes = this.$store.getters.dictKey("report.analyzetype", item.type);
          if(datatypes){
