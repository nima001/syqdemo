  ...
  <div class="wrap">
    ...
    <div class="selected-panel">
      ...
      <div class="selected-data">
        <div class="container">
          <div class="user-data" :class="[ isMulti ? 'multi-select' : '' ]">
            <div class="left" :class="[ isMulti ? 'multi-select' : '' ]">
              <a-table
                class="per-table"
                rowKey="_id"
                :columns="columns"
                ...
                :pagination="false"
                :loading="loadStatus"
                :row-selection="{ selectedRowKeys: selectedRowKeys, onChange: onSelectChange, type: isMulti ? 'checkbox' : 'radio' }"
                >
              </a-table>
            </div>
            <div v-if="isMulti" class="right multi-select">
                <ul v-if="selectedUser.length > 0">
                  <li v-for="(item, index) in selectedUser" :key="index">
                    <div class="tag">
                      {{item.username}}
                      <a-icon type="close" class="remove" />
                    </div>
                  </li>
                </ul>
