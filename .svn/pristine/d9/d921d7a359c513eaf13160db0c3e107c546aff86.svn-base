  ...
  <div class="view">
    ...
    <div class="right">
      <div class="header">
        ...
        <div class="block">
          <span class="tips">今日预约数</span>
          <ul class="numberList">
            <li v-for="(item,index) in todayNum" :key="index">{{item}}</li>
          </ul>
        </div>
      ...
      .block {
        ...
        .numberList {
          ...
          li {
            ...
            color: #fff;
            font-weight: bold;
            background: url("../../assets/img/number.png") no-repeat center
              center;
            &:first-child {
              margin-left: 0px;
            }
