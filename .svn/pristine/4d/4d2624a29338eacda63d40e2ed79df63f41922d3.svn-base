  ...
  <div class="layout">
    <div class="content">
      <div class="top">
        <div>
          <template v-if="!isOrg">
            <span class="title">值班人数:<span class="num">{{counts.count || 0}}</span></span>
            <span class="title">值班次数:<span class="num">{{counts.ondutytime || 0}}</span></span>
          </template>
...
import {orgCount} from "@/hall/api/onduty";
export default {
  components: {
