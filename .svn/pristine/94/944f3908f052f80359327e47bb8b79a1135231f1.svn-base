<template>
  <div class="annual-report">
    ...
    >
      <div class="topButton">
        <a-button class="edit" @click="enabled" icon="form" v-show="this.records.id && this.disabled">
            编辑
        </a-button>
        <a-button class="edit"  @click="handleOk" icon="form" v-show="this.records.id && !this.disabled">
            保存
        </a-button>
        <a-button v-show="!this.disabled && this.records.id" @click="enabled">取消</a-button>
      </div>
      <a-form
        :form="this.form"
        :label-col="{ span: 3 }"
