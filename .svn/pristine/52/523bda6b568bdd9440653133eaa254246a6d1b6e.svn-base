<template>
  <div class="content">
      ...
      <div class="list-content">
        <a-spin :spinning="this.tableloading">
          <div class="spin">
            <a-table
              :pagination="false"
              :class="[{'power_table': (powerList&&powerList.length)},{'history-table': (history==='history'&&!powerList.length)}]"
    ...
    <contrast v-if="this.history==='transformation'" :contrastdata="contrastdata" :intervalType="this.pagination.monthlength" :columns="this.tablecolumns" />
  </div>
</template>
