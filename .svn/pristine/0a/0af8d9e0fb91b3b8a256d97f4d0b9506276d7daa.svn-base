            ...
            <a-row :gutter='24'>
              ...
              <a-col :span='8'>
                <a-form-item label="运维联系人">
                  <a-input allowClear v-decorator="['operationContact',{ rules: [{ required: true, message: '请输运维联系人' }] }]"></a-input>
                </a-form-item>            
              </a-col>
              <a-col :span='8'>
                <a-form-item label="运维联系方式">
                  <a-input allowClear v-decorator="['operationPhone',{ rules: [{ required: true, message: '请输入运维联系人联系方式' }] }]" ></a-input>
                </a-form-item>            
              </a-col>
              <a-col :span='8'>
        ...
        <a-row :gutter='24'>
          <a-col :span='24'>
            <a-form-item label="应用简介">
              <a-textarea  :maxLength='200' allowClear :auto-size="{ minRows: 4, maxRows: 4 }" v-decorator="['desc',{ rules: [{ required: true, message: '请输入应用简介' }] }]"/>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
...
import { uploadV2,downloadUrl} from "@/framework/api/file";
...
export default {
  ...
  computed:{
    url(){
      return downloadUrl(this.iconid)
    }
  },
  methods: {
    //上传图片之前校验
