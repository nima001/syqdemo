<template>
  <div class="wrap">
    ...
    <div class="cell cell-middle">
      <p class="title">人员身份占比</p>
      <a-spin :spinning="loading" v-if="loading"></a-spin>
      <div class="chart" ref="chart" v-else></div>
    </div>
    <div class="cell">
      <identify-gather></identify-gather>
    </div>
  </div>
</template>
<script>
...
import { identity } from "@/hall/api/personcount";
import { mixins } from "../minxin/index";
import { showError } from "@/framework/utils/index";
import {Spin} from 'ant-design-vue';
import IdentifyGather from './gather/IdentifyGather';
export default {
  components: {ASpin:Spin, CustomIcon ,IdentifyGather},
  data() {
    return {
      list: [],
      total: 0,
