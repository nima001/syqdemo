      ...
      <div class="wrap">
        ...
        <div class="user-result">
          ...
          <a-row class="result" :gutter="20">
            ...
            <a-col :span="12">
              <span class="result-label">窗口职位：</span>
              <span>{{userInfo.windowposition}}</span>
            </a-col>
            <!-- <a-col :span="24">
            ...
            if (res.result.rows && res.result.rows.length) {
              ...
              this.userInfo = {
                ...
                birthday: res.result.rows[0].birthday
                  ...
                  : "",
                windowposition: this.$store.getters.dictKey('usermanage.user.windowposition', res.result.rows[0].windowposition).text,
