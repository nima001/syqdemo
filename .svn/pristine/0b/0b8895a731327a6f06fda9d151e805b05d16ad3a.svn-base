      ...
      <template v-else>
        ...
        <template>
          <a-row :gutter="20">
            ...
            <a-col :span="8" v-if="unittype == 22 || unittype == 23"> <!-- 社区和村 -->
              <a-form-item label="行政区划">
                <a-input 
                  v-decorator="['data.district', {
                    initialValue: record.data && record.data.district,
                  }]"
                />
              </a-form-item>
            </a-col>
        ...
        <a-row :gutter="20" v-if="unittype == 22 || unittype == 23">
          <template v-if="unittype == 22">
          <a-col :span="8">
            <a-form-item label="成立时间">
              <a-date-picker
                :allowClear="true"
                v-decorator="['data.buildtime', {
                  initialValue: record.data && record.data.buildtime,
                }]"
              />
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item label="批准文号">
              <a-input
                :allowClear="true"
                v-decorator="['data.approvalnum', {
                  initialValue: record.data && record.data.approvalnum,
                }]"
              />
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item label="相关村社情况">
              <a-input
                v-decorator="['data.xgcsqk', {
                  initialValue: record.data && record.data.xgcsqk,
                }]"
              />
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item label="社区类型">
              <dict-select dict="usermanage.org.communitytype"
                :allowClear="true"
                v-decorator="['data.communitytype', {
                  initialValue: record.data && record.data.communitytype,
                }]"
              />
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item label="经联社数">
              <a-input-number
                :min="0"
                style="width:100%"
                v-decorator="['data.jlss', {
                  initialValue: record.data && record.data.jlss,
                }]"
              />
            </a-form-item>
          </a-col>
          ...
          <a-col :span="8">
            <a-form-item label="法人证书">
              <dict-select dict="usermanage.org.legalcert"
                :allowClear="true"
                v-decorator="['data.legalcert', {
                  initialValue: record.data && record.data.legalcert,
                }]"
              />
            </a-form-item>
          </a-col>
