    ...
    <div class="content">
      ...
      >
        ...
        <a-form-model-item 
          ...
          <a-input v-model="form.name" placeholder="请输入"  style="width: 80%"/>
        </a-form-model-item>
        <a-form-model-item 
          label="规范简称" 
          v-bind="formItemLayout"
          ...
          <a-input v-model="form.shortname" placeholder="请输入" style="width: 80%" />
        </a-form-model-item>
        <a-form-model-item 
          label="上级组织" 
          v-bind="formItemLayout"
        ...
        <a-form-model-item 
          ...
          v-bind="formItemLayout" 
        >
          <a-input v-model="form.administrative" placeholder="请输入" style="width: 80%" />
        </a-form-model-item>
        <a-form-model-item 
          label="统一社会信用代码" 
          v-bind="formItemLayout" 
        >
          <a-input v-model="form.usccode" placeholder="请输入" style="width: 80%" />
        </a-form-model-item>
        <a-form-model-item
        ...
        >
          <a-input
            ...
            placeholder="请输入"
            style="width: 80%; margin-right: 3px"
          />
          <a-icon
        ...
        <a-form-model-item 
          ...
          v-bind="formItemLayout" 
        >
          <a-input v-model="form.connectperson" placeholder="请输入" style="width: 80%" />
        </a-form-model-item>
        <a-form-model-item 
          label="联系人手机" 
          v-bind="formItemLayout" 
        >
          <a-input v-model="form.connectmobilephone" placeholder="请输入" style="width: 80%" />
        </a-form-model-item>
        <a-form-model-item 
          label="联系人电话" 
          v-bind="formItemLayout" 
        >
          <a-input v-model="form.connectphone" placeholder="请输入" style="width: 80%" />
        </a-form-model-item>
...
import {update} from "@/idm/api/suborg"
export default {
  name: 'suborgEdit',
  components: {
    ARow: Row,
  ...
  created() {
    let orgInfo = this.$route.query.orgInfo;
    this.form.name = orgInfo.name;
    this.form.shortname = orgInfo.shortname;
    this.form.orgunittype = orgInfo.orgunittype;
    this.form.usccode = orgInfo.usccode;
  },
