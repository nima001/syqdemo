<template>
  <div class="wrap">
    ...
    <div class="cell cell-middle">
      <p class="title">人员学历占比</p>
      <a-spin :spinning="loading" v-if="loading"></a-spin>
      <div class="chart" ref="chart" v-else></div>
    </div>
    <div class="cell">
      <education-gather></education-gather>
    </div>
  </div>
</template>
<script>
...
import { education } from "@/hall/api/personcount";
import { mixins } from "../minxin/index";
import { showError } from "@/framework/utils/index";
import { Spin } from "ant-design-vue";
import EducationGather from "./gather/EducationGather";
export default {
  components: { ASpin: Spin, CustomIcon,EducationGather },
  data() {
    return {
      list: [],
      total: 0,
